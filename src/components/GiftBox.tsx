  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 py-24 text-center">
      ...
      >
        ...
        <div
          className="relative h-80 flex flex-col items-center justify-center cursor-pointer group"
          onClick={handleOpen}
        >
          {/* Background Glow */}
          ...
          <AnimatePresence mode="wait">
            {!isOpen ? (
              ...
              >
                <div className="p-10 bg-gradient-to-br from-primary via-primary to-secondary rounded-[2.5rem] shadow-[0_20px_50px_rgba(225,29,72,0.3)] animate-float border-2 border-white/20">
                ...
                >
                  <Sparkles className="w-14 h-14 text-secondary filter drop-shadow(0_0_10px_rgba(251,191,36,0.5))" />
                </motion.div>
              </motion.div>
            ) : (
              <motion.div
                ...
                className="glass rounded-[3rem] p-12 max-w-md shadow-[0_32px_64px_-12px_rgba(0,0,0,0.15)] relative z-10 overflow-hidden border border-white/60 bg-gradient-to-br from-white/95 to-primary/5"
              >
                ...
                >
                  <div className="p-5 bg-primary/10 rounded-full">
                    <Flower2 className="w-16 h-16 text-primary animate-pulse" />
                  </div>
                </motion.div>

                <h3 className="text-3xl font-serif mb-6 text-primary font-bold">
                  Siz uchun sovg‘a!
                </h3>
                ...
                <motion.button
                  ...
                  className="mt-10 px-8 py-3 bg-white border border-primary/20 text-primary rounded-full text-sm font-bold shadow-md hover:shadow-lg transition-all flex items-center gap-2 mx-auto group"
                >
                  Qayta ochish{" "}
          ...
          <motion.p
            ...
            className="mt-12 text-muted-foreground font-bold tracking-wide uppercase text-sm"
          >
            {!isOpen
