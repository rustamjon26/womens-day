      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
          <motion.button
            ...
            className="w-full sm:w-auto px-10 py-5 bg-primary text-white rounded-full font-bold text-xl shadow-2xl shadow-primary/30 flex items-center justify-center gap-3 group relative overflow-hidden transition-transform"
          >
          ...
          <motion.button
            ...
            className="w-full sm:w-auto px-10 py-5 bg-white/60 glass text-primary rounded-full font-bold text-xl hover:bg-white/80 transition-all flex items-center justify-center gap-3 border border-primary/20 shadow-xl"
          >
